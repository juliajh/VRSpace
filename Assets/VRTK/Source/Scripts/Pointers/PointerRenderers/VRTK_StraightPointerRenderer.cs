...
namespace VRTK
{
    ...
    public class VRTK_StraightPointerRenderer : VRTK_BasePointerRenderer
    {
        ...
        protected virtual float CastRayForward()
        {
            ...
            rayHit = VRTK_CustomRaycast.Raycast(customRaycast, pointerRaycast, out pointerCollidedWith, defaultIgnoreLayer, maximumLength);
            ...
            if (rayHit)
            {
                target = pointerCollidedWith.collider.gameObject;
            }
