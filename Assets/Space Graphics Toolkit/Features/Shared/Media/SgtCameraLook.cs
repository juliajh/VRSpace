...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtCameraLook : MonoBehaviour
	{
		...
		public SgtInputManager.Axis PitchControls { set { pitchControls = value; } get { return pitchControls; } } [SerializeField] private SgtInputManager.Axis pitchControls = new SgtInputManager.Axis(1, SgtInputManager.AxisGesture.VerticalDrag, 0.1f, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, 45.0f);

		/// <summary>The keys/fingers required to yaw left/right.</summary>
		public SgtInputManager.Axis YawControls { set { yawControls = value; } get { return yawControls; } } [SerializeField] private SgtInputManager.Axis yawControls = new SgtInputManager.Axis(1, SgtInputManager.AxisGesture.HorizontalDrag, -0.1f, KeyCode.None, KeyCode.None, KeyCode.None, KeyCode.None, 45.0f);

		/// <summary>The keys/fingers required to roll left/right.</summary>
		public SgtInputManager.Axis RollControls { set { rollControls = value; } get { return rollControls; } } [SerializeField] private SgtInputManager.Axis rollControls = new SgtInputManager.Axis(2, SgtInputManager.AxisGesture.Twist, -75.0f, KeyCode.E, KeyCode.Q, KeyCode.None, KeyCode.None, 45.0f);
