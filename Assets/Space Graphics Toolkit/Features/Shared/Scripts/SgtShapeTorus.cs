...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtShapeTorus : SgtShape
	{
		...
		public float Thickness { set { thickness = value; } get { return thickness; } } [FSA("Thickness")] [SerializeField] private float thickness = 0.1f;
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtShapeTorus_Editor : SgtEditor
	{
