		...
		protected override void OnInspector()
		{
			...
			if (Any(tgts, t => t.Detail == true))
			{
				BeginIndent();
					...
					EndError();
					BeginError(Any(tgts, t => t.DetailScale <= 0.0f));
						Draw("detailScale", ref dirtyMaterial, "This allows you to set how many times the detail texture is repeating along the cloud surface.");
					EndError();
